...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content rounded-0 border-0">
                <div class="modal-title-box">
                    <h3 class="modal-title text-white text-center mb-1"><b><i class="fa-solid fa-sort"></i> ФИЛТРИРАЙ ПО</b></h3>
                </div>
    ...
    <div class="modal fade" id="requestProdiuctModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content rounded-0 border-0">
                <div class="modal-title-box">
                    <h3 class="modal-title text-white text-center mb-1"><b><i class="fa-solid fa-dolly"></i> ЗАЯВКА ЗА ПРОДУКТИ</b></h3>
                </div>
                <form id="productRequestForm">
                    ...
                    while ($rows = mysqli_fetch_array($query_run)) {
                        ...
                        $query1 = "SELECT * FROM teams WHERE (user1ID = '$userID' OR user2ID = '$userID') AND deleteTeam <> 'yes'";
                        $query_run1 = mysqli_query($con, $query1);

                        while ($rowss = mysqli_fetch_array($query_run1)) {
                    ?><input type="hidden" value="<?= $rowss['name'] ?>" name="teamName">
                            <input type="hidden" value="<?= $rowss['id'] ?>" name="teamID"><?php
                                                                                        }
                                                                                    }
                                                                                            ?>
                    <div class="modal-body">
                        <div class="input-group mb-2 mt-1 d-flex justify-content-center">
                            <select id="selKindOfProduct" required="required">
                                <option hidden disabled selected>Избери категория</option>
                        ...
                        <div id="selectD-noneRemove" class="input-group mb-2 mt-1 d-flex d-none justify-content-center">
                            <select id="selProductKind" name="kind" required="required"></select>
                        </div>
                        <div class="input-group mb-4 mt-1 d-flex justify-content-center">
                            <span id="decriseNum" class="returnProduct"><i class="fa-solid fa-minus fa-lg"></i></span>
                            <input type="text" name="quantity" maxlength="3" class="numericInput" value="1">
                            <span id="increseNum" class="returnProduct"><i class="fa-solid fa-plus fa-lg"></i></span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div></div>
                            <div>
                                <button class="mdlBtn requestProdiuctModal" type="button">Откажи</button>
                                <button class="mdlBtn" type="submit">Запази</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal fade" id="viewRequestedProductModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content rounded-0 border-0">
                <div class="modal-title-box">
                    <h3 class="modal-title text-white text-center mb-1"><b><i class="fa-solid fa-box"></i> НАПРАВЕНИ ЗАЯВКИ ЗА ПРОДУКТ</b></h3>
                </div>
                <div class="modal-body">
                    <?php
                    $query = "SELECT * FROM employee WHERE pid = '$username'";
                    ...
                    while ($rows = mysqli_fetch_array($query_runn)) {
                        $teamID = $rows['teamID'];
                        $query = "SELECT * FROM productrequest WHERE YEARWEEK(date) = YEARWEEK(NOW()) AND teamID = '$teamID'";
                        $query_run = mysqli_query($con, $query);
                    ?>
                        <table class="table">
                            <?php
                            ...
                            ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= date("H:i - d.m.y", strtotime($rowss['date'])) ?></td>
                                    </tr>
                                <?php
                                }
                            } else {
                                ?> <tr colspan="3">
                                    <th class="border-0 pb-4 pt-5">Няма намерени данни</th>
                                </tr> <?php
                                    }
                                }
                                        ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <div></div>
                            <div>
                                <button id="viewRequestedProductModalClose" class="mdlBtn">Затвори</button>
                            </div>
                        </div>
                </div>
            </div>
        ...
        <div id="bodyColor" class="conrainer-fluid d-flex">
            ...
            <div class="main-section">
                <div class="fWindow">
                    ...
                    <div class="section1-1 d-none"></div>
                    <div class="section1-2 d-none d-flex justify-content-between">
                        <div></div>
                        <div class="animate__animated animate__fadeIn">
                            <i id="viewRequestedProduct" class="fa-solid fa-bars fa-2xl" style="color: #a6d5f6; cursor: pointer; margin-top: 24px; margin-right: 14px;"></i>
                            <i id="makeOrderProduct" style="color: #a6d5f6; cursor: pointer; margin-top: 24px;" class="fa-solid fa-plus fa-2xl"></i>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="cancelModalApp" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content rounded-0 border-0">
                                <div class="modal-title-box modal-title-box-color">
                                    <h3 class="text-white modal-title text-center mb-1"><b><i class="bi bi-exclamation-circle"></i> ОТКАЗ НА ЗАЯВКАТА</b></h3>
                                </div>
                    ...
                    <div class="section4 animate__animated animate__fadeIn d-none">
                        <div class="sec4-head-btn">Информация</div>
                    ...
                    <div class="modal fade" id="back-product-in-wr" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content rounded-0 border-0">
                                <div class="modal-title-box modal-title-box-color">
                                    <h3 class="text-white modal-title text-center mb-1"><b><i class="bi bi-exclamation-circle"></i> ВЪРНИ ИЗБРАНИЯ ПРОДУКТ</b></h3>
                                </div>
