   ...
   <div class="wrapper">
      <nav id="sidebar" class="sidebar js-sidebar">
         <div class="sidebar-content js-simplebar">
            <span class="sidebar-brand" href="dashboard.php">
               <span class="align-middle">Carpet Services</span>
            </span>
      ...
      <div class="main">
         <nav class="navbar navbar-expand navbar-light navbar-bg">
            ...
            <div class="navbar-collapse collapse">
               <ul class="navbar-nav navbar-align">
                  <li class="nav-item fullscreen_button" style="margin-right: -10px;">
         ...
         <main id="profSec" class="content d-none animate__animated animate__fadeIn">
            ...
            while ($rows = mysqli_fetch_array($query_run)) {
            ?>
               <input type="hidden" value="<?= $rows['id'] ?>" id="getAdminID">
                           ...
                           <div class="card-body">
                              <form id="adminInfo" class="form-horizontal form-material">
                                 ...
                                 <div class="form-group mb-4">
                                    ...
                                    <div class="col-md-12 border-bottom p-0">
                                       <input id="signInPhone" type="text" name="phone" placeholder="08 ........" class="form-control p-0 border-0 shadow-none" <?php
                                                                                                                                                                  if (!empty($rows['phone'])) {
                                                                                                                                                                  ?> value="<?= $rows['phone'] ?>" <?php
                                                                                                                                                                                                }
                                                                                                                                                                                                   ?> />
                                    </div>
                                 </div>
                           ...
                           <tbody id="tbody">
                              ...
                              ?>
                                    <tr>
                                       ...
                                       <td class="py-1"><img class="rounded-circle border border-white" src="users/userImages/<?= $rows["image"] ?>" alt=""></td>
